 ...
 * @author DAN JHONATAN
 */
public class ViewDetalhesProjetoDialog extends javax.swing.JDialog {
    
    private  static Projeto projeto;

    public ViewDetalhesProjetoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void showDetalhesDialog(Projeto projeto) {
        main(null);

        ViewDetalhesProjetoDialog.projeto = projeto;
    }
    
    private void preencherCampos(){
        jLabelNomeProjeto.setText(projeto.getNome());
        jLabelData.setText(Texto.formataData(projeto.getDataInicio()));
        jTextArea1.setText(projeto.getDescricao());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDetalhesProjetoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewDetalhesProjetoDialog dialog = new ViewDetalhesProjetoDialog(new javax.swing.JFrame(), true);
