...
import controller.extensao.FuncionalidadeJpa;
...
public class TesteFrame extends javax.swing.JFrame {
    ...
    private void initModel() {
        model1.addElement("Bleno1");
        model1.addElement("Bleno2");
        model1.addElement("Bleno3");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        model1.addElement(jTextField1.getText());
        jTextField1.setText("");
